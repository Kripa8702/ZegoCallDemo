...
class CallPage extends StatefulWidget {
  ...
  const CallPage({super.key, this.name, this.roomId});
...
class _CallPageState extends State<CallPage> {
  ...
  Future<void> stopPlayStream(String streamID) async {
    ...
    if (remoteViewID != null) {
      ZegoExpressEngine.instance.destroyCanvasView(remoteViewID ?? 0);
      setState(() {
        remoteViewID = null;
        remoteView = null;
      });
  ...
  Future<void> stopPreview() async {
    ...
    if (localViewID != null) {
      await ZegoExpressEngine.instance.destroyCanvasView(localViewID ?? 0);
      setState(() {
        localViewID = null;
        localView = null;
      });
